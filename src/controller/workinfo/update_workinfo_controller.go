...
import (
	...
	"github.com/Lipe-Azevedo/meu-primeio-crud-go/src/configuration/rest_err" // Adicionado
	...
	workinfo_request_dto "github.com/Lipe-Azevedo/meu-primeio-crud-go/src/controller/workinfo/request" // Para model.UserTypeMaster
